...
applies-to: lifecycle/Review + Build — invoked by code-review-and-quality and incremental-implementation; not path-scoped
---
...
[`code-review-and-quality`](../code-review-and-quality/SKILL.md) (Review) and Rule 0
of [`incremental-implementation`](../incremental-implementation/SKILL.md) (Build).
