...
- **Hands off to Spec:** once the idea is sharp, continue with
  [`punch-spec-driven-development`](../punch-spec-driven-development/SKILL.md) — punch-idea-refine
...
bash .github/skills/punch-idea-refine/scripts/punch-idea-refine.sh
```
