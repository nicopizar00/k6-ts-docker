...
- Build and run the suite: ./bin/punch run all --collect-logs
- Run a single test: ./bin/punch run smoke
- Clean up: ./bin/punch clean
...
For questions about the AI lifecycle or prompts, see docs/ai/operating-protocol.md and the prompts under .github/prompts/.
